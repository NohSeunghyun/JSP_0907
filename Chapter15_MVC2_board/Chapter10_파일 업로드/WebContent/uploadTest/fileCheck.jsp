...
<body>
	...
	파일명1 : <a href="file_down.jsp?file_name=<%=URLEncoder.encode(filename1,"utf-8") %>"><%=origfilename1 %></a><br>
	파일명2 : <a href="file_down.jsp?file_name=<%=URLEncoder.encode(filename2,"utf-8") %>"><%=origfilename2 %></a><br>
</body>
</html>